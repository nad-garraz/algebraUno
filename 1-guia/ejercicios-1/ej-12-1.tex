...
\def\doceiA{
  \begin{tikzpicture}[
    scale=0.8,
    baseline=0,
    nodo lleno/.style 2 args={draw, circle, color={##1}, fill={##1}, inner sep = 0.6pt, label=below: {$##2$}},
    ejes/.style={thin, color=gray, Latex-Latex}
    ]
    \draw[ejes] (-1,0) -- (10,0);
    \node[nodo lleno={magenta}{5}] at (5,0) {};
    \node[nodo lleno={OliveGreen}{8}] at (8,0) {};
    \draw[{Latex-]},thick, OliveGreen] (0.5,0) -- (8,0);
    \draw[{[-Latex},thick, magenta] (5,0) -- (9,0);
  \end{tikzpicture}
}

\def\doceiiA{
  \begin{tikzpicture}[scale=0.8, baseline=0]
    \draw[thick, Latex-Latex,] (1,0) -- (11,0);
    \draw[color=magenta] (5,0.1) circle (3pt);
    \draw[color=OliveGreen] (8,0.1) circle (3pt);
    \draw[Latex-, magenta, thick] (2,0.1) -- (5,0.1);
    \draw[-Latex, OliveGreen, thick] (8,0.1) -- (10,0.1);
    \node [color=magenta]at (5,-0.3) {5};
    \node[color=OliveGreen] at (8,-0.3) {8};
  \end{tikzpicture}
}
...
\def\doceiiE{
  \begin{tikzpicture}[
    ...
    \draw[thick, Latex-Latex,] (-4,0) -- (5,0);

    \draw[fill=magenta, color=magenta] (3,0.3) circle (3pt);
    \draw[-Latex, magenta, thick] (3,0.3) -- (5,0.3);
    \node[color=magenta] at (3,-0.3) {3};

    \draw[fill=OliveGreen, color=OliveGreen] (2,0.3) circle (3pt);
    \draw[fill=OliveGreen, color=OliveGreen] (-2,0.3) circle (3pt);
    \draw[-, OliveGreen, thick] (-2,0.3) -- (2,0.3);
    \node[color=OliveGreen] at (2,-0.3) {2};
    \node[color=OliveGreen] at (-2,-0.3) {-2};
...
\def\doceiiicero{
  \begin{tikzpicture}[scale=0.6, baseline=0]
    ...
    \draw[thick, Latex-Latex,] (-4.5,0) -- (4.5,0);

    \draw[color=magenta] (3,0.1) circle (3pt);
    \draw[color=OliveGreen] (2,0.2) circle (3pt);
    \draw[color=OliveGreen] (-2,0.2) circle (3pt);

    \draw[-Latex, magenta, thick] (3,0.1) -- (4.5,0.1);
    \draw[Latex-, OliveGreen, thick] (-4.5,0.2) -- (-2,0.2);
    \draw[-Latex, OliveGreen, thick] (2,0.2) -- (4.5,0.2);
...
\def\doceiiiuno{
  \begin{tikzpicture}[scale=0.6, baseline=0]
    ...
    \draw[fill=OliveGreen, color=OliveGreen] (2,0.2) circle (3pt);
    \draw[fill=OliveGreen, color=OliveGreen] (-2,0.2) circle (3pt);

    \draw[Latex-, magenta, thick] (-3,0.1) -- (3,0.1);
    \draw[-, OliveGreen, thick] (-2,0.2) -- (2,0.2);
...
\def\doceiiidos{
  \begin{tikzpicture}[scale=0.6, baseline=0]
    ...
    \draw[Latex-, magenta, thick] (-4,0.1) -- (3,0.1);
    \draw[Latex-, OliveGreen, thick] (-4,0.2) -- (-2,0.2);
    \draw[-Latex, OliveGreen, thick] (2,0.2) -- (4,0.2);
