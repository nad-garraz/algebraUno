  ...
  \item
        ...
        $$
          \begin{array}{c}
            ...
            \Sii{def}[$\union$]
            (x \en A \otext x \en  B  )\ytext y \en C
          \end{array}
        $$
        Si $x$ está en $A$ o en $B$ e $y$ seguro está en $C$, entonces al distribuir el "y" con el "o":
        $$
          \Sii{distribución}
          (x \en A  \ytext y \en C) \otext (x \en  B \ytext y \en C)
          \Sii{def}[\red{!}]
