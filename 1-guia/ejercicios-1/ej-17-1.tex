\def\nodosDiecisiete{
  ...
  \node[rectangle, draw = black, fit={(1)(2)(3)},inner sep = 10pt, thick, rounded corners = 10pt, label=north west:$A$] () {};
  ...
  \node[rectangle, draw = black, fit={(1b) (3b) (5) (7)},inner sep = 10pt, thick, rounded corners = 10pt, label=north east:$B$] () {};
}
\tikzset{
plot style/.style={
scale = 0.7,
...
arista/.style={-{Latex[length=3pt]}, very thin, bend left=25, color=##1},
}
}
  ...
  \item Esta es una $\relacion$:
        $$
          \begin{tikzpicture}[ plot style ]
            ...
            \draw[arista=Cerulean, bend right=10pt] (1) to (7);
