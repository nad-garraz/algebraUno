\def\veintidosi{
  \begin{tikzpicture}[
    ...
    arista/.style={-{Latex[length=2pt]}, very thin, bend left=15, color={##1}},
    rulo/.style 2 args = {-{Latex[length=2pt]}, out=##1, in=##1+45, looseness=4, color={##2}},
    universo/.style={rectangle, draw, thick, rounded corners=5pt},
    ]
    ...
    % Al final para que agarre todo lo graficado
      \node[universo, fit = (4)(2)(5), label=above right:$A$, inner sep = 8pt] (){};
  \end{tikzpicture}
}
% fin gráficos
...
\begin{enumerate}[label=\roman*)]
  ...
  \item $
        ...
        La relación no es antisimétrica. Se puede ver con la \magenta{primera o cuarta} fila tabla
