...
\begin{enumerate}[label=\roman*)]
  ...
  \item Primero notemos que $a + b$ es par puede pensarse como $a + b = 2k, k \in \naturales$, esto lo digo
        ...
        Que una relacion sea transitiva significa que $a \relacion b \ytext b \relacion c \entonces a \relacion c$.
  ...
  \item  Primero notamos que como hay un $\leq$ ya nos da una idea de que probablemente vaya a ser una relacion de orden. \\
        \textit{Reflexiva: }
