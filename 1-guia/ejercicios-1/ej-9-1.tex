...
\begin{itemize}
  \item[($\magenta{\Rightarrow}$)] Quiero probar que:
        ...
        $$
          A \nsubseteq B
          \Sii{def}[\red{!}]
          \existe x \en A \text{ tal que } x \stackrel{\llamada1}{\notin} B.
        $$
        ...
        Entonces el conjunto $\set{x}$ también tiene que estar en $\partes(B)$.
