...
\begin{itemize}[label={\tiny\faIcon{smile}}]
  ...
  \item \hypertarget{teoria-1:relaciones}{\textit{Relaciones $\relacion$:}}

        \begin{itemize}[label=\tiny\faIcon{yin-yang}]
          \item
                \textit{Definición de relación: }

                Sean $A$ y $B$ conjuntos. Una relación $\relacion$ de $A$ en $B$ es un subconjunto
          ...
          \item
                \textit{Definición de relación en un conjunto: }
