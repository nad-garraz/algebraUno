...
\begin{enumerate}[label=\roman*)]
  ...
  \item
        ...
        Si te quedaste ahí pedaleando en el aire en el \red{!!!} es solo acomodar la expresión, nada raro, algún factor común, $\ub{(-1)^2 = 1}{\text{\tiny \faIcon{meh-rolling-eyes}}}$ y coso... \href{\justDoIt}{power!}.
  ...
  \item
        ...
        $$
        Si te quedaste pedaleando en los \red{!}, pensá en \textit{diferencia de cuadrados}, \textit{propidades de potencias} y coso \faIcon{hands-wash}.\par
