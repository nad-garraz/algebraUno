...
\textit{Sobre $\cyan{f(3) \leq f(4) \leq f(5)}$  y \magenta{$f(1) + f(2)$ es impar}:}
...
Con el tema de la otra condición, los de $\cyan{f(3), f(4), f(5)}$, \underline{no importa} cuales \cyan{3} números \textit{distintos} $\set{\cyan{a, b, c}} \en \cod(f)$
...
$$
  \cajaResultado{
    2 \cdot \left(
    \binom{4}{1} \cdot \binom{4}{1}
    \right) \cdot \binom{6}{3} \cdot 3!  =
    2 \cdot 16 \cdot 120 \cdot 6 = 23040
  }
$$
\begin{aportes}[3]
