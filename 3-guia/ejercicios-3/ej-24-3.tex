...
\begin{enumerate}[label=\orange{\faIcon{lemon}$_\arabic*$)}]
  ...
  \item
        Otra forma de encarar: Tengo que poner 2 objetos \textit{repetidos, iguales, indistinguibles entre sí} en 14 lugares y eso de repetidos nos hace dividir por el factorial ¿O no?:
        $$
