...
\begin{enunciado}{\ejercicio}
  ...
  esa semana si no quiere consumir más de una \orange{naranja} por día.
\end{enunciado}
...
\begin{enumerate}[label=\orange{\faIcon{lemon}$_\arabic*$)}]
  ...
  \item
        ...
        $$
          ...
          \end{array}
        $$
        Peeeeeero, ojo que estamos contando el doble, porque el razonamiento sirve para dos objetos \underline{distintos},
        por eso hay que dividir entre 2. A \Pedro no le importa cual de las 2 naranjas:
        $$
          \frac{14 \cdot 12}{2} = 84 \llamada1
        $$

  \item
        También se puede pensar como que tengo que poner 2 objetos repetidos en 14 lugares y eso de repetidos nos hace dividir por el factorial ¿O no?:
        $$
          \frac{\binom{14}{2}}{2!} = 91
        $$
        ...
        $$
          \frac{\binom{14}{2}}{2!} \red{- 7} = 84 \llamada1
        $$
\end{enumerate}
