...
\begin{itemize}
  ...
  \item \underline{Formas en las que Lucía, María y Diego van caminando}
        ...
        Con el último auto no queda nada por hacer, pues se ponen las únicas cuatro personas que quedan.
...
$$
  \cajaResultado{
    \binom{3}{1} \cdot \binom{13}{2} \cdot \binom{11}{4} \cdot \binom{7}{4}
    -
    \binom{3}{1} \cdot \binom{10}{2} \cdot \binom{8}{4}
    = 2702700 - 9450 = 2.693.250
  }
$$
