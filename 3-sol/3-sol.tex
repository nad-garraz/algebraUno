...
Como $A$ tiene al 1 y al 3, los elementos $C$, \textit{conjuntos en este caso}, pertenecientes a la clase $\overline A$
deberían cumplir que si $C \subseteq \overline A \entonces
	\llaves{cc}{
		1 \en C&\\
		3 \en C&\\
		2 \notin C &\to \text{ si } 2 \en C \entonces A\cancel\relacion C
	} $.\\
