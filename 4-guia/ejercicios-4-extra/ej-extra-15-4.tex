...
Hay que tener cuidado cuando se hace la tabla de restos y hay dos parámetros, $a$ y $b$, porque
estos \underline{no tienen que tener el mismo resto a la vez}, entonces se puede proceder así:
...
$$
  ...
  \flecha{busco una \magenta{combinación} suma que me dé}[$r_5(a^2 + 3b^2) \conga5 0$]
  \cajaResultado{
    r_5(a^2 + 3b^2) = 0
    \sii
    \llave{l}{
