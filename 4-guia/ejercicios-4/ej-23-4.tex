...
\begin{enumerate}[label=\enumeracion*)]
  ...
  \item
        ...
        $4a+4$ tiene que dividir a 16, onda $\frac{16}{4a + 4} \en \enteros$ por lo tanto necesitamos:
        $$
          4a + 4 \en \set{\pm1,\pm2,\pm4,\pm8,\pm16}.
        $$
        ...
        $$
          \begin{array}{rcc}
            ...
            4 \cdot \magenta{(-3)} + 4 & = & \blue{-8}  ~~ \skull \\
            4 \cdot \magenta{(-2)} + 4 & = & \blue{-4}            \\
            4 \cdot \magenta{0} + 4    & = & \blue{4}   ~~ \skull \\
            4 \cdot \magenta{1} + 4    & = & \blue{8}   ~~ \skull \\
            4 \cdot \magenta{3} + 4    & = & \blue{16} ~~ \skull
          \end{array}
        $$
        reemplazando esos valores de $\magenta{a}$ en $\llamada1$ se obtiene que se comprueba para cuales
        valores funciona que$\llamada1 \en \enteros$.
\end{enumerate}
