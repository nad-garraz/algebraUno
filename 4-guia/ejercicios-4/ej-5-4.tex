...
escribir como el producto de 2 números menores,
en particular son dos divisores de $n$:
$$
  n = d_1 \cdot d_2
$$
...
\begin{enumerate}[label=\roman*)]
  \item  Mirá el ejercicio \refEjercicio{ej:3} a ver si se te ocurre como usar ese resultado en esta parte.
        ...
        A partir del resultado del ejercicio \refEjercicio{ej:3}:
        ...
        $$
          \begin{array}{rcl}
            ...
            a^n - b^n = (a - b) \cdot k                 \\
             & \Sii{$a = 2^{d_1}$}[$n = d_2$] &
              (2^{d_1})^{d_2} - b^{d_2} = (2^{d_1} - b) \cdot k \\
             & \Sii{$b = 1$}                  &
