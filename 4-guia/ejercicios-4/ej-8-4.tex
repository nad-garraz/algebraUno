...
\parrafoDestacado[\purple{\atencion}]{
  $\magenta{r}$ tiene que cumplir condición de resto: $0 \leq \magenta{r} < |d|$.
}
...
\begin{enumerate}[label=\alph*)]
  ...
  \item
        Cuando $b$ sea mayor que $a$ el resto va a ser simplemente $a$. Esto se cumple para:
        $$
          \ob{n^2 + 1}{b} > \ob{n + 3}{a}
          \sii
          n^2 - n - 2 > 0
          ...
          n > 2
          \sii
          \cajaResultado{n \geq 3}.
        $$
        Hago los casos separados para $n = 1$ y $n = 2$ a manopla:

        Para $n = 1$:
        $$
          a = 4,\, b = 2, \, \blue{q} = 2,\, \magenta{r} = 0
        $$
        Para $n = 2$:
        $$
          a = 5,\, b = 5,\, \blue{q} = 1,\, \magenta{r} = 0
        $$
        Finalmente todo daría:
        $$
          \cajaResultado{
            \blue{q_b(a)} =
            \begin{cases}
