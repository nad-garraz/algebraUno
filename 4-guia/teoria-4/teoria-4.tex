...
\begin{itemize}
  ...
  \item A la hora de laburar con la divisibilidad \textit{``los signos no importan'':}
        $$
          \llave{rcl}{
  ...
  \item Propiedades súper útiles para justificar los cálculos en los ejercicios:
        $$\llave{l}{
        ...
        $$
          \text{\red{Error recurrente: }} d \divideA a \cdot b \cancel\entonces
          \llave{c}{
            d \divideA a \\
            \otext       \\
            d \divideA b
...
\begin{itemize}[label=$\scriptscriptstyle\blacksquare$]
  \item \textit{Definición congruencia: }
        $$
          \llave{l}{
            \textit{'$a$' es congruente a '$b$' módulo '$d$'} \text{ si }   d \divideA a-b. \quad \text{ Notación } \boxed{\congruencia{a}{b}{d}} \\
            \congruencia{a}{b}{d} \Sii{def} d \divideA a-b
          }
        $$

  \item Sumar ecuaciones de congruencia \textit{de mismo módulo}, conserva la congruencia:
        $$
          \llave{c}{
          ...
          \entonces \congruencia{a_1 + \cdots + a_n}{b_1 + \cdots + b_n}{d}
        $$.

  \item Multiplicar ecuaciones de congruencia \textit{de mismo módulo}, conserva la congruencia:
        $$
          \llave{c}{
            \congruencia{a_1}{b_1}{d} \\
            \vdots                    \\
        ...
        $$
          ...
          \red{\entonces} \boxed{\congruencia{a^n}{b^n}{d}}
        $$
\end{itemize}
...
\begin{itemize}
  \item
    ...
    \item \textit{Notación: } \boxed{r_{\red{d}}(\red{a})} es el \textit{resto de dividir a $\red{a}$ entre $\red{d}$}.
...
\begin{itemize}[label=\tiny\faIcon{grimace}]
  ...
  \item Propiedades del $(a:b)$, con $a$ y $b \en \enteros$, no ambos nulos.
  ...
  \item \textit{Algoritmo de Euclides}:
        ...
        \red{¡Se usa de acá hasta el final de la materia!}.
  ...
  \item \textit{Primos y Factorización: }
        \begin{itemize}[label=\tiny\faIcon{meh}]
          \item Sea $p$ primo y sean $a,b \en \enteros$. Entonces:
                ...
                $$
          \item\hypertarget{teoria4:priProductos}{\textit{Si $p$ divide a algún producto de números, tiene que dividir a alguno de los factores}}.

                Sean $a_1,\dots, a_n \en \enteros$:
                $$
                  \llave{l}{
                    p \divideA a_1 \cdot a_2 \cdots a_n \entonces p \divideA a_i \text{ para algún } i \text{ con } 1 \leq i \leq n. \vspace{2pt}\\
