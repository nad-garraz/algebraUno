	...
	\item \textit{\underline{Primos y Factorización:}}
	      \begin{itemize}
		      ...
		      \item Si $a \en \enteros$, $p$ primo:\\
		            ...
		            \end{center}
		      \item Sea $n \en \enteros - \set{0},\, n = \ub{s }{\set{-1,1}} \cdot \productoria{i=1}{r} p_i^{\alpha_i} $ su factorización
		            en primos. Entonces todo divisor positivo de $n$ se escribe como:\\
		            \[
			            \llave{c}{
			            \productoria{i=1}{r} p_i^{\beta_i} \text{ con } 0 \leq \beta_i \leq \alpha,\, \paratodo 1\leq i \leq r\\
			            \text{ y hay } \\
			            (\alpha_1 + 1) \cdot (\alpha_2 + 1)\cdots (\alpha_r + 1) = \productoria{i=1}{r} \alpha_i +1 \\
