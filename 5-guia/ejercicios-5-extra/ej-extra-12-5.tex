...
$$
\fcolorbox{orange}{white}{$p = 3$, sí sirve.} $\llamada3$
...
$$
\fcolorbox{orange}{white}{$p = 5$, sí sirve.} $\llamada4$
...
$$
Encuentro de esta forma que el \fcolorbox{orange}{white}{$p = 13$, sí sirve.} $\llamada6$
