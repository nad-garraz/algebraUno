...
Donde $\llamada1$ se puede hacer de 2 formas. \textit{MEGA TABLA DE RESTOS} y \textit{qué elegancias la de Francia}:
$$
  ...
  \end{array}
$$
O una manera más \textit{salonera}:
$$
  \congruencia{a^2}{4}{17}
  \Sii{def}
  17 \divideA a^2 - 4
  \sii
  17 \divideA (a - 2) \cdot (a + 2)
$$
Dado que 17 es un número primo, debe ocurrir que:
$$
  17 \divideA a - 2  \Sii{def} \blue{\congruencia{a}{2}{17}}
  ~~~\text{o} ~~~
  17 \divideA a + 2  \Sii{def} \blue{\congruencia{a}{15}{17}}
$$
Mismo resultado que en la tabla de rezos \faIcon{pray}.
