...
$ (\ub{a^{1081}+ 3a + 17}{m} : \ub{105}{3\cdot 5 \cdot 7})  = \ub{35}{5 \cdot 7}
	...
	\llave{l}{
		...
		\to
		\llave{ll}{
			\text{si} & 5 \dividea a \to \congruencia{2}{0}{5} \magenta{ ningún $a$ } \skull  \\
			\text{si} & 5 \noDivide a
		...
		\to
		\llave{ll}{
			\text{si} & 7 \dividea a \to \congruencia{3}{0}{7} \magenta{ ningún $a$ } \skull  \\
			\text{si} & 7 \noDivide a
		...
		\llave{ll}{
			...
			\llave{l}{
				\text{si } 3 \dividea m \to \congruencia{2}{0}{3} \to \text{\magenta{ningún $a$} $\skull$ , pero } \\
