...
{\tiny(Es útil recordar que $z = \re(z) + i\im(z) \entonces \im(z) = \frac{z - \conj{z}}{2}$)}
$$
  ...
  \llave{l}{
    ...
    \Sii{\red{!}}[$\llamada1$] \theta_k = \frac{1}{5}k\pi \text{ con } k \en [0,4]
  }
$$
...
Finalmente:
$$
  z_k = 2 e^{\theta_k i} \quad \text{ con  $ \theta_k = \frac{1}{5}k\pi \ytext k \en [0,4]$}
$$
