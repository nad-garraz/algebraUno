...
o esas raíces. El último \textit{resto no nulo hecho} \textbf{mónico} será el MCD.

\medskip

$$
  \divPol{X^5 + 2X^4 - 7X^3 - 7X^2 + 10X -15}{X^4 - X^3 +6X^2 - 5X +5}
$$
Euclides me dice que:
$$
  \begin{array}{rcl}
    (f : X^4 - X^3 +6X^2 - 5X +5) & \igual{\red{!}} & (X^4 - X^3 +6X^2 - 5X +5 : \ub{X^3 + 2X^2 - 2X + 3}{\text{lo hice mónico\red{!}}})
  \end{array}
$$
Divido otra vez haciendo así más Euclides:
$$
  \divPol{X^4 - X^3 +6X^2 - 5X +5}{X^3 + 2X^2 - 2X + 3}
$$
Euclides me tira ahora que:
$$
  \begin{array}{rcl}
    (f : X^4 - X^3 +6X^2 - 5X +5) & =               & (X^4 - X^3 +6X^2 - 5X +5 : X^3 + 2X^2 - 2X + 3)                        \\
                                  & \igual{\red{!}} & (X^3 + 2X^2 - 2X + 3 : \ub{X^2 - X + 1}{\text{lo hice mónico\red{!}}})
  \end{array}
$$
Una vez más \rollingEyes:
Divido otra vez haciendo así más Euclides:
$$
  \divPol{X^3 + 2X^2 - 2X + 3}{X^2 - X + 1}
$$
Finalmente identifico con el algoritmo de Euclides al MCD que es el último resto \textit{distinto de 0}:
$$
  \begin{array}{rcl}
    (f : X^4 - X^3 +6X^2 - 5X +5) & =               & (X^4 - X^3 +6X^2 - 5X +5 : X^3 + 2X^2 - 2X + 3) \\
                                  & =               & (X^3 + 2X^2 - 2X + 3 : X^2 - X + 1)             \\
                                  & =               & X^2 - X + 1 : 0)                                \\
                                  & \igual{\red{!}} & X^2 - X + 1
  \end{array}
$$
...
\underline{Sin} usar calculadora ni Gauss ni ninguna cosa extraña podemos expresar a $f$ como:
