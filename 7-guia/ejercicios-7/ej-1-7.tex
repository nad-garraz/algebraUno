...
\begin{enumerate}[label=\roman*)]
  ...
  \item \textit{coeficiente principal: }
        ...
        Cuando sumo me queda: $\cp(f^4) - \cp(g) = (-3)^4 - 81 = 0$, esto quiere decir que no sé cual es el
        coeficiente principal, porque el $0$ está matando al término $X^{20}$. Tengo entonces gr(f^4 + g) < 20 $\par
          Calculo el $\cp(f^4+g)$ con $\gr(f^4 + g ) = 19$.\par
