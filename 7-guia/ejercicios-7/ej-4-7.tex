...
\begin{enumerate}[label=\roman*)]
  \item \divPol{5X^4 + 2X^3 - X + 4}{X^2 + 2} \par

        Resultado válido para $\racionales[X],\,\reales[X],\,\complejos[X]$

  \item \divPol{4X^4 + X^3 - 4}{2X^2 + 1} \par
  ...
  \item Después de hacer un par iteraciones en la división asoma la idea de que:
        ...
        $ X^n - 1 = (X-1) \cdot \ub{\sumatoria{j=0}{n-1} X^j}{q[X]} + \ub{0}{r[X]}$, \qquad\qquad{\tiny(que es la geométrica con $X \distinto 1$)}\par
