...
\begin{enumerate}[label=\roman*)]
    \item
        ...
        Luego, el valor de $a \en \complejos$ tal que $X^3 + 2X^2 + 2X + 1$ es divisible por $X^2 + aX + 1$ es \boxed{$a = 1$}.
        ...
        Luego, el único valor de $a \en \complejos$ tal que el resto de dividir a $X^5 - 3x^3 - x^2 - 2X + 1$ por $X^2 + aX + 1$ sea $-8X + 4$ es \boxed{$a = -2$}
\end{enumerate}