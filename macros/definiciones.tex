...
\newcommand{\ejercicio}{%
    ...
    \section*{\noindent\theejercicio.\clap{\labelEjercicio{ej:\theejercicio}}}%
}
...
\newcommand{\ejExtra}{%
    ...
    \titleformat{\section}[runin]{\bfseries}{\theejExtra}{0em}{\vspace{40pt}\separador}[ ]%
    \section*{\noindent{\color{orange}{\faIcon{fire}}}\theejExtra.\clap{\labelEjExtra{ejExtra:\theejExtra}}}%
}
...
\newcommand{\refEjExtra}[1]{{ \bf\ref{#1}.}}
