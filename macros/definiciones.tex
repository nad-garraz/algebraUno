...
\def\magic{\href{https://www.youtube.com/watch?v=VNKuARjkWEg}{\faIcon{magic}}\xspace}
...
\NewDocumentCommand{\ejExtra}{o}{%
  ...
  \IfNoValueTF{#1}{%
    \addcontentsline{toc}{subsection}{\protect\space 🔥 Ejercicio Parcial \theejExtra}%
  }{%
    \addcontentsline{toc}{subsection}{\protect\space 🔥 Ejercicio Parcial \theejExtra: #1}%
  }%
