...
\newcommand{\hacer}{
  ...
  {\color{black!70!white}
    \small Si querés mandarlo: Telegram $\to$ \href{\dirTelegram}{\small\telegram},
    o  mejor aún si querés subirlo en \LaTeX $\to$ \href{\dirRepo}{\small \github}.
  }\par
}
...
\newcommand{\llamada}[1]{
  ...
  \fi
  \textcolor{\colortemp}{\text{{\tiny \FiveStar}}^{\scriptscriptstyle#1}}
  \endgroup
}
...
%%% Iconos más usados
\def\github{{\color{violet!50!black}{\faIcon{github}}}}
